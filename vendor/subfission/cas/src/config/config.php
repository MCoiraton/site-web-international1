...
return [
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'auth.univ-lorraine.fr'),
    ...
    */
    ...
    | Empty is fine
    */
    'cas_login_url'       => env('CAS_LOGIN_URL', 'https://auth.univ-lorraine.fr/login'),
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://auth.univ-lorraine.fr/logout'),
