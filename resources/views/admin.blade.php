...
<body class="bg-gray-200 h-full">
    ...
    <div class="flex flex-row pt-5 pb-4 overflow-y-auto">
        <div class="flex-grow p-4 m-6 rounded-lg bg-white">
            <a href="/admin/accueil" id="accueil" class="text-base text-gray-900 font-normal rounded-lg flex flex-col items-center p-2 hover:bg-gray-300 group">
                {{ $accueil ?? '' }}
                <svg class="mt-4 w-32 h-32 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="ml-3 mt-8 text-xl">Gestion page d'accueil</span>
            </a>
        </div>
        <div class="flex-grow p-4 m-6 rounded-lg bg-white">
        ...
        <div class="flex-grow p-4 m-6 rounded-lg h-96 bg-white">
