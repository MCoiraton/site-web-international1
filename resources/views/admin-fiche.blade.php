                    ...
                    <div class="w-full max-w-full">
                        ...
                        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input value="<?php if ($candidature && $candidature->id) echo ($candidature->id); ?>" disabled class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="uid" type="number">
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <select required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="choix1" class="border-black-600 border-2">
                            ...
                            <div class="mt-4">
                                ...
                                <select required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="choix2" class="border-black-600 border-2">
                            ...
                            <div class="mt-4">
                                ...
                                <select required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="choix3" class="border-black-600 border-2">
                            ...
                            <div class="mt-4">
                                ...
                                <select required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="choix4" class="border-black-600 border-2">
                                ...
                                <label for="S5">S5</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S5") echo ("checked"); ?> id="5" type="radio" name="semestre_choix4" value="S5" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S7">S7</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S7") echo ("checked"); ?> id="7" type="radio" name="semestre_choix4" value="S7" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S9">S9</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S9") echo ("checked"); ?> id="9" type="radio" name="semestre_choix4" value="S9" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S5+6">S5+6</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S5+6") echo ("checked"); ?> id="5" type="radio" name="semestre_choix4" value="S5+6" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S7+8">S7+8</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S7+8") echo ("checked"); ?> id="7" type="radio" name="semestre_choix4" value="S7+8" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S9+10">S9+10</label>
                                <input <?php if ($candidature && $candidature->semestre_choix4 == "S9+10") echo ("checked"); ?> id="9" type="radio" name="semestre_choix4" value="S9+10" class="choixS my-1 border-black-600 border-2">
                            </div>
                            <div class="mt-4">
                                <label for="choix5">Choix 5 :</label>
                                <select required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="choix5" class="border-black-600 border-2">
                                ...
                                <label for="S5">S5</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S5") echo ("checked"); ?> id="5" type="radio" name="semestre_choix5" value="S5" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S7">S7</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S7") echo ("checked"); ?> id="7" type="radio" name="semestre_choix5" value="S7" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S9">S9</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S9") echo ("checked"); ?> id="9" type="radio" name="semestre_choix5" value="S9" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S5+6">S5+6</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S5+6") echo ("checked"); ?> id="5" type="radio" name="semestre_choix5" value="S5+6" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S7+8">S7+8</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S7+8") echo ("checked"); ?> id="7" type="radio" name="semestre_choix5" value="S7+8" class="choixS my-1 border-black-600 border-2">
                                <label class="ml-4" for="S9+10">S9+10</label>
                                <input <?php if ($candidature && $candidature->semestre_choix5 == "S9+10") echo ("checked"); ?> id="9" type="radio" name="semestre_choix5" value="S9+10" class="choixS my-1 border-black-600 border-2">
                            </div>
