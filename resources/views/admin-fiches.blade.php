        ...
        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            ...
            <div class="flex flex-row">
                <form id="exportExcel" method="POST" action="{{ action('FastExcelController@exportCandidature') }}">
                    ...
                    <button form="exportExcel" class="items-center hover:bg-green-700 hover:text-white bg-white text-green-700 px-3 py-2 rounded-md text-sm font-medium"> Exporter sous format Excel </button>
                </form>
            </div>
