    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
              ...
              <div id="dropdown" class="hidden z-10 w-auto bg-blue-600 rounded px-1 py-1 my-4">
                  <ul class="py-1" aria-labelledby="dropdownButton">
                    ...
                    foreach($destinations as $destination){
                        ...
                        echo("<li><a href=\"/$destination\" class=\"text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium\">$destination</a></li>");
                    }
                    ?>
                  </ul>
              </div>
        ...
        <div class="origin-right flex">
          @if(!session()->has('uid'))
          <a href="/auth/login" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Connexion UL</a>
          @else
          <a href="/Profil" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium flex">
          ...
          <a href="/auth/logout">
            <button type="button" class="p-1 rounded-full text-blue-400 hover:text-white hover:bg-blue-700">
