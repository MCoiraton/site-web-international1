...
<body>
    <div class="flex items-center justify-center bg-gray-200">
        <nav class="bg-white border-b border-gray-200 fixed z-30 w-full px-3 py-3 lg:px-5 lg:pl-3 flex items-center justify-start">
        ...
        <div class="flex bg-white pt-16">
            <aside id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64" aria-label="Sidebar">
                <div class="relative flex-1 flex flex-col min-h-0 border-r rounded-lg border-gray-200 bg-white pt-0">
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <a href="" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <span class="ml-3 flex-1 whitespace-nowrap">Fiches Candidatures</span>
                                </a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="fixed w-max z-40 top-16 mt-2 left-64">
            {{ $panel ?? '' }}
        </div>
