          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            ...
            <div class="flex flex-col space-x-4">
              <div class="flex flex-row">
                <span class="px-3 py-2 text-sm font-medium">{{$photo}}</span>
              ...
              <img id='{{$url}}' style="display: none" class="m-4 object-contain w-full" src="/{{$url}}"/></div>
            @endforeach
            <label class="uppercase md:text-sm text-xs mt-5 text-gray-500 text-light font-semibold">Ajouter de nouvelles images</label>
